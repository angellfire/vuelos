		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="date" class="form-control" id="telefono" name="telefono" placeholder="Telefono" value="<?php echo $row['telefono']; ?>" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" id="estado_civil" name="estado_civil">
							<option value="PENDIENTE" <?php if($row['estado_civil']=='PENDIENTE') echo 'selected'; ?>>PENDIENTE</option>
							<option value="RECEPCIONADO" <?php if($row['estado_civil']=='RECEPCIONADO') echo 'selected'; ?>>RECEPCIONADO</option>
